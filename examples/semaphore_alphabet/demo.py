...
def recognize_gesture(b):  
    ...
    if b.scores[KEYPOINT_DICT['right_elbow']] < b.score_thresh or \
        ...
        return None
    right_arm_angle = angle_with_y(b.keypoints[KEYPOINT_DICT['right_elbow']] - b.keypoints[KEYPOINT_DICT['right_shoulder']])
    left_arm_angle = angle_with_y(b.keypoints[KEYPOINT_DICT['left_elbow']] - b.keypoints[KEYPOINT_DICT['left_shoulder']])
